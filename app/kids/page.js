                                            ...
                                            filtered.map((product, index) => (
                                                <Card key={index} className="p-4 flex flex-col gap-2">
                                                    <div className="flex justify-center items-center border rounded-lg ">
                                                        <Link href={`/kids/${product._id}`} className="flex justify-center items-center w-[200px] h-[300px] overflow-hidden">
                                                            <img src={product.filename[0].name} alt={product.filename[0].name} className="object-cover" />
                                                        </Link>
                                                    </div>
                                                    <div>
                                                        <Link href={`/kids/${product._id}`}><h3 className="font-semibold text-lg truncate ...">{product.productName}</h3></Link>
