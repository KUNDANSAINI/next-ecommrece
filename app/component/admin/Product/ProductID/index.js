...
function ProductDetailsPage({ id, getBrands, getCategory, getSubCategory, getSingleProduct }) {
    ...
    useEffect(() => {
        if (getSingleProduct) {
            setSingleProductData({
                ...
                hns: getSingleProduct.hns,
                category: getSingleProduct.category,
                subCategory: getSingleProduct.subCategory,
                brand: getSingleProduct.brand,
                price: getSingleProduct.price,
                discount: getSingleProduct.discount,
                warranty: getSingleProduct.warranty,
                delivery: getSingleProduct.delivery,
                offers: getSingleProduct.offers,
                desc: getSingleProduct.desc,
                qty: getSingleProduct.qty,
                size: getSingleProduct.size,
            });

            setImages(getSingleProduct.filename);

            if (getSingleProduct.filename && getSingleProduct.filename.length > 0) {
                setSideImage(getSingleProduct.filename[0].name);
            }
        } else {
